...
class TestExtractionSchema:
    ...
    def test_from_json_file(self):
        ...
        schema_data = {
            "document_info": {"doc_number": {"type": "string"}, "date": {"type": "string", "format": "date"}}
        }
...
class TestUpstageInformationExtractor:
    ...
    def setup_method(self):
        ...
        self.extractor = UpstageInformationExtractor(api_key=self.api_key, extraction_type="universal")
    ...
    def test_initialization(self):
        ...
        # Test prebuilt type
        prebuilt_extractor = UpstageInformationExtractor(api_key=self.api_key, extraction_type="prebuilt")
    ...
    async def test_extract_with_schema(self, mock_http, mock_validate):
        ...
        mock_http.return_value = {
            "data": {"invoice_date": "2024-01-15", "total_amount": 1000.0, "vendor_name": "Test Vendor"}
        }
...
class TestBatchInformationExtractor:
    ...
    async def test_batch_extraction(self):
        ...
        extractor = BatchInformationExtractor(api_key="up_test_key", extraction_type="universal")
        ...
        with patch.object(extractor, "extract", side_effect=mock_extract):
            results = await extractor.extract_batch(files, keys=["test_key"])
