...
from pyhub.config import Config, get_default_toml_path, get_default_env_path
...
class TestConfig:
    ...
    def test_default_paths(self):
        ...
        assert toml_path == Path.home() / ".pyhub-mcptools" / "config.toml"
        assert env_path == Path.home() / ".pyhub-mcptools" / ".env"
    ...
    @patch.dict(os.environ, {
        "PYHUB_CONFIG_DIR": "/config",
        "PYHUB_TOML_PATH": "/explicit/config.toml"
    })
